...
//            sendNotification(title, message);
    ...
    public void onNewToken(@NonNull String s) {
        super.onNewToken(s);
        DatabaseReference firebaseDatabase = FirebaseDatabase.getInstance("https://gasdetectror-default-rtdb.firebaseio.com/").getReference().child("GasLeakage").child("token");
